...
public class EmployeeDao {
    ...
    static {
        ...
        employees.put(1003, new Employee(1003, "CC", "7767546755@qq.com", 1, new Department(103,"运营部")));
        employees.put(1004, new Employee(1004, "DD", "7654788797@qq.com", 0, new Department(104,"教研部")));
